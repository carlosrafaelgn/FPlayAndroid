...
-keep class br.com.carlosrafaelgn.fplay.plugin.wirelessvisualizer.Plugin
-keepclassmembers class br.com.carlosrafaelgn.fplay.plugin.wirelessvisualizer.Plugin {
    public *;
}

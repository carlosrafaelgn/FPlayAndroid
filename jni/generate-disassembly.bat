...
rem cd D:\Android\workspace\FPlay\obj\local\armeabi-v7a\objs\MediaContextJni\x
...
rem cd D:\Android\workspace\FPlay\obj\local\x86\objs\MediaContextJni\x
rem D:\Android\sdk\ndk-bundle\toolchains\x86-4.9\prebuilt\windows-x86_64\bin\i686-linux-android-objdump -S -d MediaContextJni.o > x86.txt
rem move x86.txt D:\Android\workspace\FPlay\jni\x86.txt
